    ...
    <main className="min-h-screen bg-black px-6 py-20 text-neutral-100">
      <article className="mx-auto max-w-3xl">
        <nav className="mb-8 text-sm text-neutral-500">
          ...
          <Link href="/symbols" className="hover:text-neutral-300">
            Symbols
          </Link>
          <span className="mx-2">/</span>
          <span className="text-neutral-300">{symbol.title}</span>
        </nav>
        ...
        <h1 className="text-5xl font-bold">{symbol.title}</h1>

        <p className="mt-4 text-neutral-400">{symbol.tradition}</p>
        ...
        {symbol.related.length > 0 && (
          <section className="mt-16 border-t border-neutral-800 pt-10">
            <h2 className="text-2xl font-semibold">Related Symbols</h2>
