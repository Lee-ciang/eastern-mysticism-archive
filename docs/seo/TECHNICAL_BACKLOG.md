...
Ancestor Worship QA on 2026-07-28 reproduced the same approximately `76px` overflow across the tested routes. The new ancestor-veneration visual introduced no additional component overflow.
